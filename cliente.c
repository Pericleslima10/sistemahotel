...
void limparNovaLinha(char *string)
{
...
void novocliente()
{
    ...
    limparNovaLinha(cliente.nome_cliente);

    printf("Digite o CPF do cliente: ");
    fgets(cliente.cpf_cliente, sizeof(cliente.cpf_cliente), stdin);
    limparNovaLinha(cliente.cpf_cliente);

    printf("Data de Nascimento do cliente (DD/MM/AAAA): ");
    fgets(cliente.data_nasc, sizeof(cliente.data_nasc), stdin);
    limparNovaLinha(cliente.data_nasc);
